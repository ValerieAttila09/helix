...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="w-full bg-black min-h-screen px-6 sm:px-8 md:px-[8%] lg:px-[12%] py-12 sm:py-16 md:py-20 space-y-12">
      <div className="">
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          {FAQS_DATA.map((item, i) => (
            <div key={i} className="bg-[#0f0f0f] border border-neutral-800 rounded-none overflow-hidden">
              ...
              >
                <span className="text-sm text-blue-400 flex-1">{item.q}</span>
                <svg
