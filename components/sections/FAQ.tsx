...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="w-full bg-black min-h-screen px-[6%] sm:px-[8%] md:px-[12%] py-20 space-y-12">
      <div className="">
        <div className="mb-10 pb-8">
          ...
          <h2 className="text-5xl font-semibold leading-tight text-background">Everything You Need to Know</h2>
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          {FAQS_DATA.map((item, i) => (
            <div key={i} className="bg-[#0f0f0f] border border-neutral-800 rounded-none overflow-hidden">
              ...
              >
                <span className="text-sm text-blue-400">{item.q}</span>
                <svg
                  className={`w-4 h-4 text-neutral-400 transform transition-transform duration-200 ${openIndex === i ? 'rotate-180' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div
                ...
                className="px-5 text-sm text-neutral-300"
              >
